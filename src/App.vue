          ...
          <div class="max-w-xs">
            ...
            <div class="mt-1 relative rounded-md shadow-md">
              <input
                ...
                name="wallet"
                id="wallet"
                class="block w-full pr-10 border-gray-300 text-gray-900 focus:outline-none
      ...
      <template v-if="tickers.length">
        ...
        <dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-3">
          ...
          >
            ...
            <button
              @click.stop="btnDelHandler(elem)"
              class="flex items-center justify-center font-medium w-full bg-gray-100 px-4
                     py-4 sm:px-6 text-md text-gray-500 hover:text-gray-600 hover:bg-gray-200
...
export default {
  ...
  methods: {
    ...
    btnDelHandler(elem) {
      this.tickers = this.tickers.filter((item) => item !== elem);
    },
